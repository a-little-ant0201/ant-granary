...
# 本地图像
hhl_image = face_recognition.load_image_file("hhl.jpg")
hhl_face_encoding = face_recognition.face_encodings(hhl_image)[0]
...
# 本地图片三
liujunbo_image = face_recognition.load_image_file("xp.jpg")
